...
def createScene(rootNode):
                ...
                cp_upNode.createObject('BeamInterpolation', name='Interpol', crossSectionShape='rectangular', lengthY='2.167', lengthZ='0.025', defaultYoungModulus='0.1e9', dofsAndBeamsAligned='0', DOF0TransformNode0=DOF0TransformNode, DOF1TransformNode1=DOF0TransformNode)
                ...
                cp_downNode.createObject('BeamInterpolation', name='Interpol', crossSectionShape='rectangular', lengthY='2.167', lengthZ='0.025', defaultYoungModulus='0.1e9', dofsAndBeamsAligned='0', DOF0TransformNode0=DOF0TransformNode, DOF1TransformNode1=DOF0TransformNode)
                cp_downNode.createObject('AdaptiveBeamForceFieldAndMass',  name="BeamForceField", computeMass="1", massDensity="0.0016")
                
                                
                
               
                #applying mapped external force
                
                Point= smawormNode.createChild('SMAPoint')
                Point.createObject('MechanicalObject', position='5.2 0 0', name='location')
                Point.createObject('ConstantForceField',name='SMAForce', points= "0", forces='0 0 100', arrowSizeCoef="0.001")
